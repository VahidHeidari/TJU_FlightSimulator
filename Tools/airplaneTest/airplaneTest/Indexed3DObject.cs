...
namespace Framework
{
    public class IndexedNormal
    {
...
#if _VECTORS
        protected CustomVertex.PositionColored[] Lines;
        protected bool m_Normals = true;
        ...
        protected void Read(string FileName)
        {
            ...
            m_mtrl.SpecularSharpness = 100.0f;
        ...
        public IndexedNormal(string FileName, string TexturePath)
        {
            m_texture = TextureLoader.FromFile(MainClass.Graphic, TexturePath);

            Read(FileName);
        }
        public IndexedNormal(string FileName, Texture texture)
        {
            m_texture = texture;
        ...
        protected void ComputeNormals(ref CustomVertex.PositionNormalTextured[] Verts, ref int[] IndeXes)
        {
    ...
    {
        public Glass(string FileName, string TexturePath)
            :base(FileName,TexturePath)
        {
            m_mtrl.Diffuse = Color.FromArgb(96, Color.White);
        }
        public Glass(string FileName, Texture texture)
            : base(FileName, texture)
        {
            m_mtrl.Diffuse = Color.FromArgb(96, Color.White);
        }
